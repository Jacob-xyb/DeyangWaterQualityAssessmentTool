...
if __name__ == '__main__':
    path="E://shixi//github_mycellar//DeyangWaterQualityAssessmentTool//整合//input_param.xlsx"
    ...
    #path3 = ref.iat[7, 2]
    #path4 = ref.iat[8, 2]
    path5 = "E://shixi//github_mycellar//水质参数//after_12.tif"
    ...
    """写入部分"""
    writer = pd.ExcelWriter('C:/Users/Administrator/Desktop/s2b_20200216_FAI11.xlsx')
    # 写入Excel文件
    df.to_excel(writer, float_format='%.5f')  # ‘page_1’是写入excel的sheet名 # 不写就是默认第一页
    writer.save()
    writer.close()
