...
if __name__ == '__main__':#C:\Users\Administrator\PycharmProjects\input_param.xlsx
    ...
    #多波段三张表，一张参数表，两张测评表，其中参数表多两列NDVI 和 FAI
        ...
        print("输入有误")
    '''
    file1 = 'E://shixi//github_mycellar//DeyangWaterQualityAssessmentTool//整合//多波段图计算结果.xlsx'  # 自己跑出来要检验结果的文件
    file2 = "E://shixi//github_mycellar//DeyangWaterQualityAssessmentTool//整合//s2b_20200317_waterRrs.xlsx" # 只含1，0的"原文件"
